...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2026 a las 01:19:18
...
(31, 15, 79, 1, '2026-04-19 18:08:27', '::1', 0),
(32, 15, 171, 1, '2026-04-19 21:33:14', '::1', 0);
...
(15, 'RENDELIZADO', 'cc971f4058963538', 2, 1, '2026', 'I', '2026-03-16', '2026-04-30', '21:20:00', '21:35:00', 'Ocaña', 10, 'Académico', 'Presencial', 'Tecnólogo', NULL, 0, 0, 0, 0, 1, '2026-03-17 02:18:38', NULL, 'activo');
...
(131, 171, 1, 99, 1, 4, NULL),
(132, 172, 1, 18, 1, 4, NULL);
...
(1, 'Año 2026 • Semestre I (Ene - Jun)', '2026-01-01', '2026-06-30', 'activo');
...
(3, 5, 'CC', '1090111222', 'Jorge Andres', 'Ferreira', 'ja.ferreira@fesc.edu.co', '312333333', NULL, 'activo'),
...
(7, 3, 'CC', '1090999001', 'Luis Fernando', 'Castro', 'l.castro@fesc.edu.co', '+573124567890', NULL, 'activo'),
...
(76, 1, 'CC', '123456789', 'YEISON', 'JIMÉNEZ', 'hsjshssh@fesc.com', '3124567890', NULL, 'activo'),
(78, 1, 'CC', '60365777', 'GLORIA', 'FERREIRA', 'gr@gmail.com', NULL, NULL, 'activo'),
(79, 3, 'CC', '1090555444', 'ELVIO', 'LADO', 'el@hotmail.es', '31244456643', NULL, 'activo'),
...
(83, 4, 'CC', '1004842461', 'WILMAN', 'MORA', 'est_wa_mora@fesc.edu.co', '31244456643', NULL, 'activo'),
(84, 2, 'CC', '1090111111', 'ANGEL', 'UREÑA', 'au@fesc.edu.co', '3124567890', NULL, 'activo'),
(85, 2, 'CC', '1090501419', 'PEDRO', 'PEREA', 'pp@fesc.edu.co', '312456789', NULL, 'activo'),
...
(159, 1, 'PASAPORTE', '1090999007', 'LUIS FERNANDO', 'CASTRO', 'l.castro@fesc.edu.co', '+573188283292', NULL, 'activo'),
...
(170, 1, 'CC', '1090501', 'JORGE', 'FERREIRA', 'ja.ferreira@fesc.edu.co', '3124567890', NULL, 'activo'),
(171, NULL, 'CC', '1090333210', 'EMILSA', 'ORTEGA', 'EO@GMAIL.COM', '', NULL, 'pendiente'),
(172, 4, 'PASAPORTE', '1090999005', 'ANDRES', 'CASTRO', 'ca@fesc.edu.co', '+573188283292', NULL, 'activo');
...
CREATE TABLE `usuarios_sistema` (
  ...
  `rol` enum('superadmin','admin','monitor') NOT NULL DEFAULT 'monitor',
  `deleted_at` datetime DEFAULT NULL,
...
(1, 'JF - ', 'DEV', 'Ferreiraortegajorgeandres@gmail.com', '$2y$10$T53xU5gjNKUu63c4K59F1OLuLnngLaiKkGS3qM7c.Wh6PjD.My3RO', 'superadmin', NULL, NULL, NULL),
(6, 'ANDRES', 'ALVAREZ', 'bienestar@fesc.edu.co', '$2y$10$e1oe3pPjyvT3XTmDieHKretGePWml8jDxKaG.5w6YyEYN48fT.CyC', 'superadmin', NULL, NULL, NULL);
