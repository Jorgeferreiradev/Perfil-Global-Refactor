        ...
        <div class="card border-danger shadow-sm">
            ...
            <div class="card-body bg-light">
                <p class="text-muted small mb-3">
                    <strong>Atención:</strong> Estas acciones alteran el periodo académico activo. El cierre de semestre pasará a todos los estudiantes actuales a estado "histórico" y preparará el sistema para un Nuevo Semestre.
                </p>
