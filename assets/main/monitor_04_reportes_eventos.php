...
<head>
    <meta charset="UTF-8">
    <title>Reportes por Evento</title>
...
<div class="container mt-5">
    <h2 class="mb-4">📑 Reportes por Evento</h2>
    ...
    <form method="GET" class="row g-3 mb-4">
        ...
        <div class="col-12 d-flex justify-content-between mt-3">
            ...
            <a href="monitor_04_reportes_eventos.php" class="btn btn-secondary">Limpiar</a>
        </div>
    </form>
            ...
            <tbody>
                <?php foreach ($eventos as $evento): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($evento['fecha_inicio']) ?> - <?= htmlspecialchars($evento['fecha_final']) ?></td>
                        <td><?= htmlspecialchars($evento['nombre_linea']) ?></td>
                        <td><?= htmlspecialchars($evento['nombre_programa']) ?></td>
                        <td class="d-flex gap-2">
    <a href="monitor_generar_reporte_evento_excel.php?id_evento=<?= $evento['id_evento'] ?>" class="btn btn-success btn-sm">📥 Excel</a>
    <a href="monitor_generar_reporte_evento_pdf.php?id_evento=<?= $evento['id_evento'] ?>" class="btn btn-danger btn-sm">📄 PDF</a>
</td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
